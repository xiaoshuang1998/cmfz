        ...
        $("#articleTable").jqGrid(
            {
                ...
                styleUI: "Bootstrap",
                height: "500px",
                editurl: "${pageContext.request.contextPath}/article/removeArticle"
            });
        $("#articleTable").jqGrid('navGrid', '#articlePage', {edit : false,add : false,del : true,edittext:"编辑",addtext:"添加",deltext:"批量删除"})
    });
    // 点击添加文章时触发事件
